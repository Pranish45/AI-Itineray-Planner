...
import { Plane, Heart, Github, Twitter, Linkedin, Mail } from 'lucide-react';
          ...
          <div className="lg:col-span-2">
            ...
            >
              <div className="flex items-center space-x-3 mb-4">
                ...
                <h3 className="text-2xl font-bold">AI Travel Planner</h3>
              </div>
              ...
              <ul className="space-y-3">
                {links.map((link, linkIndex) => (
                  <motion.li
                    ...
                    transition={{ duration: 0.4, delay: 0.1 * (categoryIndex + 3) + linkIndex * 0.05 }}
                    viewport={{ once: true }}
                  >
                    <a
                      href={link.href}
        ...
        >
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-gray-400 mb-6">
              Get the latest travel insights, AI updates, and exclusive offers delivered to your inbox.
            </p>
